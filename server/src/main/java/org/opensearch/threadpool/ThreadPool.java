...
public class ThreadPool implements ReportingService<ThreadPoolInfo>, Scheduler {
    ...
    public ThreadPool(
        ...
        builders.put(Names.SEARCH, new ResizableExecutorBuilder(settings, Names.SEARCH, searchThreadPoolSize(allocatedProcessors), 1000, taskAwareRunnableListener));
        builders.put(Names.SEARCH_THROTTLED, new ResizableExecutorBuilder(settings, Names.SEARCH_THROTTLED, 1, 100, taskAwareRunnableListener));
