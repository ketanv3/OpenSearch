...
/**
 * TaskCancellation represents a task eligible for cancellation. It doesn't guarantee that the task will actually get
 * cancelled or not; that decision is left to the caller.
 *
 * It contains a list of cancellation reasons, along with
 * callbacks that are invoked when cancel() is called.
 *
 * @opensearch.internal
 */
